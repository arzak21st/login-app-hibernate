                    ...
                    <ul class="navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                                ...
                                <!-- User Image -->
                                <img alt="image" src="stisla/dist/assets/img/avatar/avatar-4.png" class="rounded-circle mr-1">
                                ...
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="card profile-widget">
                                        ...
                                        <div class="profile-widget-header">
                                            <img alt="image" src="stisla/dist/assets/img/avatar/avatar-4.png" class="rounded-circle profile-widget-picture">
